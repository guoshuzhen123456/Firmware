	...
	_timestampGps()
{
	...
	_P0Diag(Xe::rot_e) = 5;
	_P0Diag(Xe::rot_d) = 10;
	_P0Diag(Xe::vel_n) = 1e3;
	_P0Diag(Xe::vel_e) = 1e3;
	_P0Diag(Xe::vel_d) = 1e3;
	_P0Diag(Xe::gyro_bias_n) = 1e-3;
	_P0Diag(Xe::gyro_bias_e) = 1e-3;
	_P0Diag(Xe::gyro_bias_d) = 1e-3;
	_P0Diag(Xe::accel_scale) = 1e-3;
	_P0Diag(Xe::pos_n) = 1e6;
	_P0Diag(Xe::pos_e) = 1e6;
	_P0Diag(Xe::pos_d) = 1e6;
	_P0Diag(Xe::terrain_alt) = 1e6;
